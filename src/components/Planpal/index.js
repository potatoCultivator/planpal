...
setOptions({
  ...
  const defaultEvents = [
    {
      id: 1,
      start: '2024-02-16T13:00',
      end: '2024-02-16T15:00',
    ...
    {
      id: 3,
      start: '2024-02-16T18:00',
      end: '2024-02-16T22:00',
      title: 'Dexter BD',
      description: '',
      allDay: false,
      free: true,
  ...
  const viewSettings = {
    timeline: { type: 'day', interval: { start: '06:00', end: '20:00' }, vertical: true },
  };
  ...
  return (
    <div>
      ...
      <Snackbar
        ...
        button={{
          action: () => {
            setMyEvents((prevEvents) => [...prevEvents]);
          },
          text: 'Undo',
        }}
      />
